...
{
	draw_rect(0, 0, arena_half_size_x, arena_half_size_y, 0xf);
	draw_arena_borders(arena_half_size_x, arena_half_size_y, 0x000c1f);
...
#pragma endregion
	...
	else
	{
		...
		if (hot_button == 0)
		{
			draw_text("SINGLE MODE", -80, 10, 1, 0xbe1b4c);
			draw_text("MULTIPLAYER", 0, -10, 1, 0xb0afc5);

		}
		else
		{
			draw_text("SINGLE MODE", -80, -10, 1, 0xb0afc5);
			draw_text("MULTIPLAYER", 0, 10, 1, 0xbe1b4c);
		}
